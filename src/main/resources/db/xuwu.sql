...
Source Database       : xuwu

Target Server Type    : MYSQL
Target Server Version : 50519
File Encoding         : 65001

Date: 2019-01-07 17:39:55
*/
...
CREATE TABLE `house` (
  ...
  `last_update_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '最近数据更新时间',
...
CREATE TABLE `user` (
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '用户账号创建时间',
