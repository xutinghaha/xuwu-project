...
public class MailServiceTest extends XuwuProjectApplicationTests {
    ...
    public void sendAttachmentsMail() {
        ...
        mailService.sendAttachmentsMail("916466357@qq.com", "主题：带附件的邮件", "有附件，请查收！", filePath);
    }
    ...
    public void sendInlineResourceMail() {
        ...
        mailService.sendInlineResourceMail("916466357@qq.com", "主题：这是有图片的邮件", content, imgPath, rscId);
    }
}